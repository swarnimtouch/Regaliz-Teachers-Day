...
class DoctorReelsExport implements FromQuery, ShouldAutoSize, WithHeadings, WithMapping, WithStyles
{
    ...
    {
        return ['Reference ID', 'Doctor Name', 'Speciality', 'City', 'Mobile', 'Hospital', 'Type', 'Status', 'Downloads', 'Submitted At', 'Completed At'];
    }

    public function map($reel): array
    {
        return [$reel->reference_id, $reel->doctor_name, $reel->speciality, $reel->city, $reel->mobile, $reel->hospital_name, $reel->content_type, $reel->status, $reel->download_count, $reel->created_at, $reel->processing_completed_at];
    }

    public function styles(Worksheet $sheet): array
    {
        $sheet->getStyle('A1:K1')->getFill()->setFillType('solid')->getStartColor()->setARGB('FF245337');
