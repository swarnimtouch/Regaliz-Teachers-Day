...
<section class="audio-page section-wrap">
    ...
    <div class="audio-recorder">
        <img src="{{ asset('images/teachers-day-card-page-1.png') }}" alt="Teacher's Day card banner">
        ...
        <audio id="audioPreview" controls hidden></audio><p id="audioError" class="record-error"></p><small>Maximum recording duration: 90 seconds</small>
    </div>
</section>
